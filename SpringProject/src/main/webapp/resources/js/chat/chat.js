...
// 페이지 로딩 완료 시 채팅창을 제일 밑으로 내리기(즉시 실행 함수(IIFE) => 속도가 빠르고, 변수명 중복문제 해결)
(
	function() {
...
chattingSock.onmessage = function(e) {
	// 매개변수 e : 발생한 이벤트에 대한 정보를 담고 있는 객체
	// e.data : 전달된 메세지가 담겨 있음(JSON객체) ==> message.getPayload()
